...
const TIER_LIMITS = {
  ...
  // screen.
  //
  // UNMETERED. The two daily OUTBOUND cap keys this set used to carry
  // (callsPerDay: 20 / messagesPerDay: 10, forge/free-tier-p1 2026-08-28) were
  ...
  // MAKE_CALL / SEND_SMS, and there is no LIMIT_REACHED frame.
  // tests/no-daily-caps.test.js pins that absence. This set is therefore the
  // same SHAPE as every paid set: exactly the four keys below.
  //
