 ...
 *
 * Run: node scripts/ext-sw-lifetime-proof.mjs [seconds]   (default 360)
 */
...
try {
  ...
  console.log('\n=== RESULT ===');
  console.log('with socket:', JSON.stringify({
    survivedWholeRun: report.arms.withSocket.survivedWholeRun,
    firstGoneAtSeconds: report.arms.withSocket.firstGoneAtSeconds,
    respawned: report.arms.withSocket.respawned,
  }));
  console.log('idle       :', JSON.stringify({
    survivedWholeRun: report.arms.idle.survivedWholeRun,
    firstGoneAtSeconds: report.arms.idle.firstGoneAtSeconds,
    respawned: report.arms.idle.respawned,
  }));
} finally {
