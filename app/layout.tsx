...
export const metadata: Metadata = {
  ...
  description:
    "Call any phone number from your computer or browser. ComputerCaller connects your phone to your computer — we never store your call logs, messages, or contacts. 5-day free trial.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Call any phone number from your computer through your existing phone. We never store your calls, SMS, or contacts. 5-day free trial.",
    images: [
      {
