...
// Bulk reorder quick-reply templates. Mirrors PUT /api/templates/reorder exactly
// (same contract, auth, and semantics) — only the Prisma model differs.
//
  ...
  try {
    ...
    await db.$transaction(
      orderedIds.map((id, index) =>
        db.quickReplyTemplate.updateMany({
