...
- relay: REAL `node server.js` pid 38668 on ephemeral port 4105, scratch Postgres postgresql://pix:pix@localhost:15433/cc
...
| SAS digits (read off the two SURFACES) | `29057` | `29057` | `ABSENT — no SAS impl in the shipped extension` | YES |
...
| kid | `AZLsdT-NpkG7H0zxW5m-nQ` | _(none)_ | _(none)_ | NO |
| mode | `ON` | `Encrypted` | `counts-only` | NO |
| phone armed line (post-confirm) | `E2E armed kid=AZLsdT-NpkG7H0zxW5m-nQ epoch=1 mode=ON verifie` | _(none)_ | _(none)_ | YES |
